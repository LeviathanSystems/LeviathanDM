...
**New in v0.0.3**: Widget-based popovers! Build complex popup layouts using composable widgets (VBox, HBox, Label). See the [Widget System Guide](/docs/development/widget-system).
